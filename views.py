...
def show_analytics():
    ...
    if session.get("user_id"):
        ...
        user_id=None
    return render_template("analytics.html", strokes=strokes, text=text, raw_text=raw_text, user_id=user_id)
...
def continue_keyboard():
    ...
    return render_template("keyboard.html", prompt=prompt.text)
